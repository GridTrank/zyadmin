                ...
                <div class="drag-box-item">
                    ...
                    <draggable v-model="doing" @remove="removeHandle" :options="dragOptions">
                        <transition-group tag="div" id="doing" class="item-ul">
                            <div v-for="(item,index) in doing" class="drag-list" :key="item.id" @dragstart="dragstart(index)" 
...
export default {
    ...
    methods: {
        ...
        dragenter(e,index){
            let list=JSON.parse(JSON.stringify(this.doing))
            if (this.dragIndex !== index) {
                console.log(1231231231,index,this.dragIndex);
